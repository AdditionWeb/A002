...
<?php } else { ?>
    ...
    if ( has_post_thumbnail() ) {
        ...
        if (!empty($section_bg)) {
            $ember_parallax="data-parallax='scroll' data-image-src='" . esc_url($section_bg) . "' style='background: rgba(0, 0, 0, 0.35);'";
            $parallax_active="parallax_active";
        } elseif( tribe_is_view( 'month' ) || tribe_is_view( 'list' ) || tribe_is_view( 'day' ) ) {
            $ember_parallax="data-parallax='scroll' data-image-src='" . esc_url( get_option( 'a002_events_page_banner' ) ) . "' style='background: rgba(0, 0, 0, 0.35);'";
            $parallax_active="parallax_active";
        } elseif( is_404() ) {
            $ember_parallax="data-parallax='scroll' data-image-src='" . get_stylesheet_directory_uri() . "/assets/images/404.png'";
            $parallax_active="parallax_active";
        } else {
            $ember_parallax="data-parallax='scroll' data-image-src='" . get_template_directory_uri() . "/assets/images/preview/fire.jpg' style='background: rgba(0, 0, 0, 0.35);'";
            $parallax_active="parallax_active";
